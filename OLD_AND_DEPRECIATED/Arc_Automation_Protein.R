...
Output <- paste("/home/home02/umnjmc/GCA_PRS/PRSice/", Protein_name, "/", Protein_name, sep = "")
New_Sun_file_location <- paste("/nobackup/umnjmc/Sun_data/Sun_", Protein_name, "_ALL.txt", sep = "")
Protein_directory <- paste("/home/home02/umnjmc/GCA_PRS/PRSice/", Protein_name, sep = "")
