...
PRSice_R_location <- "/home/home02/umnjmc/Tools_Software/PRSice.R"
PRSice_exec_location <- "/home/home02/umnjmc/Tools_Software/PRSice_linux"
GCA_data <- "/nobackup/umnjmc/GCA_data/chr#"
PCA <- "/home/home02/umnjmc/GCA_PRS/PCA/PCA_regions_removed.eigenvec"
Extract <- "/home/home02/umnjmc/GCA_PRS/SOCS3_v3.valid"
Output <- paste("/nobackup/umnjmc/PRSice/", Protein_name, "/", Protein_name, sep = "")
New_Sun_file_location <- paste("/nobackup/umnjmc/Sun_data/Sun_", Protein_name, "_ALL.txt", sep = "")
Protein_directory <- paste("/nobackup/umnjmc/PRSice/", Protein_name, sep = "")
...
##### Copy all .summary files into same folder #####

system(paste("cp ", Output, ".summary", " /home/home02/umnjmc/GCA_PRS/PRSice", sep = ""))
